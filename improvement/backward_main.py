...
def get_args():
    ...
    parser.add_argument('-fl', '--flood_level', help='loss threshold used for flooding', type=float, default=0.1)
...
def main(args):
    for flood_level in np.arange(0.0,0.3, 0.02):
        writer = SummaryWriter('./logs/gaussain_HIGH_flodding_backward'+str(flood_level))
